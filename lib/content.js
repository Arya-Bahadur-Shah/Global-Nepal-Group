...
export const DEFAULT_FOOTER_COLUMNS = [
  {
    ...
    links: [
      ...
      { label: 'Trackline', href: '/software-solutions/trackline' },
      { label: 'On Service', href: '/software-solutions/on-service' },
    ],
  },
  {
    ...
    links: [
      { label: 'Factory Traceability', href: '/industrial-solutions/factory-traceability' },
      { label: 'Vision & Quality', href: '/industrial-solutions/industrial-vision-systems' },
      { label: 'Machinery Fleet IoT', href: '/industrial-solutions/machinery-fleet-iot' },
      { label: 'Smart Warehouse', href: '/industrial-solutions/smart-warehouse-automation' },
    ],
  },
  {
    title: 'Hardware',
    href: '/hardware',
    links: [
      { label: 'Zebra', href: '/hardware/zebra' },
      { label: 'Rynan', href: '/hardware/rynan' },
      { label: 'HID', href: '/hardware/hid' },
      { label: 'Yesmark', href: '/hardware/yesmark' },
    ],
  },
  {
    title: 'Industries',
    ...
    links: [
      ...
      { label: 'FMCG & Food', href: '/industries/fmcg-food-beverage' },
      { label: 'Pharmaceuticals', href: '/industries/pharmaceuticals' },
      { label: 'Manufacturing', href: '/industries/manufacturing-cement-steel' },
    ],
  },
  {
    title: 'Company',
...
export async function getSite() {
  ...
  const footerColumns = parseJson(row.footerColumns, null)
  ...
  return {
    ...
    footerColumns: Array.isArray(footerColumns) && footerColumns.length ? footerColumns : DEFAULT_FOOTER_COLUMNS,
  }
}
