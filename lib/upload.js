...
const LIMITS = {
  image: { maxBytes: 25 * 1024 * 1024, mimePrefix: 'image/', label: 'Image' },
  video: { maxBytes: 500 * 1024 * 1024, mimePrefix: 'video/', label: 'Video' },
  doc: { maxBytes: 50 * 1024 * 1024, mimePrefixes: ['application/pdf', 'application/', 'image/'], label: 'Brochure/spec sheet' },
}
