            ...
            <Reveal key={item.slug} delay={(idx % 3) * 0.08}>
              ...
              >
                <div className="relative aspect-[16/9] bg-ocean overflow-hidden">
                  {item.visual ? (
                    <Image src={item.visual} alt={item.name} fill sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" className="object-cover group-hover:scale-105 transition-transform duration-500" />
                  ) : (
